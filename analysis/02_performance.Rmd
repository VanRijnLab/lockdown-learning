...
Make a combination plot for in the paper:
```{r}
plot_grid(p_english_y1, p_english_y2, p_english_y3, p_english_y4, p_change_english,
          ncol = 1,
          align = "hv", axis = "tblr",
          labels = c("Year 1", "Year 2", "Year 3", "Year 4", "Change"),
          rel_heights = c(1, 1, 1, 1, 1.5),
          hjust = -0.1,
          scale = .95)

ggsave("../output/progress_combi_english.pdf", width = 9, height = 11)
ggsave("../output/progress_combi_english.png", width = 9, height = 11)
```
